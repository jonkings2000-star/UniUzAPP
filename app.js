...
<div class="grid"><button class="btn" onclick="showSchedule()">🗓️ ${tr("schedule")}</button><button class="btn" onclick="showHomework()">📝 ${tr("homework")}</button><button class="btn" onclick="showAI()">🤖 ${tr("ai")}</button><button class="btn" onclick="showReminders()">🔔 ${tr("reminders")}</button><button class="btn" onclick="showProfile()">👤 ${tr("profile")}</button>${profile?.is_admin?`<button class="btn" onclick="showAdmin()">🔐 ${tr("admin")}</button>`:""}</div>`)}
